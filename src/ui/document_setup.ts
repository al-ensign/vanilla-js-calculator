...
const divide = new Button("btn operation special", "divide", "&#247")
const square = new Button("btn operation", "square", "x&#178")
const cube = new Button("btn operation", "cube", "x&#179")
const anyPower = new Button("btn operation", "anyPower", "x&#x207F")
...
const multiply = new Button("btn operation special", "multiply", "&#215")
const tenPowerX = new Button("btn operation", "tenPowerX", "10<sup>x</sup>")
const root = new Button("btn operation", "root", "&#8730")
const cubicRoot = new Button("btn operation", "cubicRoot", "<sup>3</sup>&#8730")
const four = new Button("btn number", "four", "4")
const five = new Button("btn number", "five", "5")
const six = new Button("btn number", "six", "6")
const plus = new Button("btn operation special", "plus", "&#43")
const nRoot = new Button("btn operation", "nRoot", "<sup>n</sup>&#8730")
const divideByX = new Button(
  "btn operation",
  "divideByX",
  "&#x215F<sub>x</sub>"
)
const factorial = new Button("btn operation", "factorial", "!x")
const one = new Button("btn number", "one", "1")
const two = new Button("btn number", "two", "2")
const three = new Button("btn number", "three", "3")
const minus = new Button("btn operation special", "minus", "&#8722")

const empty = document.createElement("div")
empty.className = "empty span-3"
buttonsDiv.appendChild(empty)

const changeSign = new Button("btn operation", "changeSign", "&#177")
